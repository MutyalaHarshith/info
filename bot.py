...
START_TEXT = """<b>Hello {}
I am a Simple Telegram Info BoT From @Harshith_Mutyala, Click /help to know my Commands and my uses<b>"""
...
ABOUT_TEXT = """--**About Me**--
- **Bot :** `Info Bot`
- **Creator :** [Harshith](https://telegram.me/Harshith_Mutyala)
- **Credits :** `Everyone in this journey`
- **Source :** [Harshith](https://t.me/Harshith_Mutyala)
- **Language :** [Python3](https://python.org)
- **Library :** [Pyrogram v1.2.0](https://pyrogram.org)
- **Server :** [Heroku](https://heroku.com)"""

BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton(text="SOURCE", url=f"https://t.me/Harshith_Mutyala")]])
...
async def info(bot, update):
    ...
    text = f"""--**Information From @Harshith_Mutyala**--
